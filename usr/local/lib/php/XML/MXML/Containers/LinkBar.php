...
/**
 * XML/MXML/Containers/LinkBar.php
 *
 * LinkBar element.
 *
 * @package XML_MXML
...
require_once 'XML/MXML/Containers/NavBar.php';
 ...
 * @author   Markus Nix <mnix@docuverse.de>
 */
class XML_MXML_Containers_LinkBar extends XML_MXML_Containers_NavBar
{
    // {{{ public properties
    /**
     * Element name.
