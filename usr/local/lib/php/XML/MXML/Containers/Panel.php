...
require_once 'XML/MXML/Containers/VBox.php';
 ...
 * @author   Markus Nix <mnix@docuverse.de>
 */
class XML_MXML_Containers_Panel extends XML_MXML_Containers_VBox
{
    // {{{ public properties
    /**
     * Element name.
