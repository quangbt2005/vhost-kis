...
/**
 * XML/MXML/Validators/DateValidator.php
 *
 ...
 * @author   Markus Nix <mnix@docuverse.de>
 */
class XML_MXML_Validators_DateValidator extends XML_MXML_Validators_Validator
{
    // {{{ public properties
    /**
     * Element name.
     ...
     * @var    string
     */
    public $elementName = 'DateValidator';
    ...
    public function __construct($attributes = array(), $cdata = null)
    {
        ...
        $this->addAttributeDefinitions(array(
            ...
            'wrongMonthError' => array(
                'required' => false,
                'type'     => 'string',
                'since'    => '1.0'
            ),
            'wrongYearError' => array(
                'required' => false,
                'type'     => 'string',
                'since'    => '1.0'
            )
