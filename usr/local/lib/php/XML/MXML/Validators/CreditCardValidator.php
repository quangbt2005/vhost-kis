...
/**
 * XML/MXML/Validators/CreditCardValidator.php
 *
 ...
 * @author   Markus Nix <mnix@docuverse.de>
 */
class XML_MXML_Validators_CreditCardValidator extends XML_MXML_Validators_Validator
{
    // {{{ public properties
    /**
     * Element name.
     ...
     * @var    string
     */
    public $elementName = 'CreditCardValidator';
