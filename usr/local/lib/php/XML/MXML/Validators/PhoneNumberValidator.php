...
/**
 * XML/MXML/Validators/PhoneNumberValidator.php
 *
 ...
 * @author   Markus Nix <mnix@docuverse.de>
 */
class XML_MXML_Validators_PhoneNumberValidator extends XML_MXML_Validators_Validator
{
    // {{{ public properties
    /**
     * Element name.
     ...
     * @var    string
     */
    public $elementName = 'PhoneNumberValidator';
