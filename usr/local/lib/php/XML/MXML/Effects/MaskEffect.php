...
/**
 * XML/MXML/Effects/MaskEffect.php
 *
 * MaskEffect element.
 *
 * @package XML_MXML
...
require_once 'XML/MXML/Effects/TweenEffect.php';
 ...
 * @abstract
 */
abstract class XML_MXML_Effects_MaskEffect extends XML_MXML_Effects_TweenEffect
{
    // {{{ public properties
    /**
     * Element name.
