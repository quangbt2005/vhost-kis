 ...
 * @author   Markus Nix <mnix@docuverse.de>
 */
abstract class XML_MXML_Core_View extends XML_MXML_Core_UIComponent
{
    // {{{ public properties
    /**
     * Element name.
    ...
    public function __construct($attributes = array(), $cdata = null)
    {
        ...
        $this->addAttributeDefinitions(array(
            ...
            'childDestroyed' => array(
                'required' => false,
                'type'     => 'string',
                'since'    => '1.0'
            ),
            'childIndexChanged' => array(
                'required' => false,
                'type'     => 'string',
                'since'    => '1.0'
            )
