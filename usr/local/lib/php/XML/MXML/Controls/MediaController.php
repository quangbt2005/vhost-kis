...
/**
 * XML/MXML/Controls/MediaController.php
 *
 ...
 * @author   Markus Nix <mnix@docuverse.de>
 */
class XML_MXML_Controls_MediaController extends XML_MXML_Core_UIComponent
{
    // {{{ public properties
    /**
     * Element name.
     ...
     * @var    string
     */
    public $elementName = 'MediaController';
    ...
    public function __construct($attributes = array(), $cdata = null)
    {
        ...
        $this->addAttributeDefinitions(array(
            'activePlayControl' => array(
                'required' => false,
                'type'     => 'boolean',
                'since'    => '1.0'
            ),
            'associatedDisplay' => array(
                'required' => false,
                'type'     => 'string',
                'since'    => '1.0'
            ),
