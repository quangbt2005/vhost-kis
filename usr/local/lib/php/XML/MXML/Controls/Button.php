...
require_once 'XML/MXML/Controls/SimpleButton.php';
 ...
 * @author   Markus Nix <mnix@docuverse.de>
 */
class XML_MXML_Controls_Button extends XML_MXML_Controls_SimpleButton
{
    // {{{ public properties
    /**
     * Element name.
    ...
    public function __construct($attributes = array(), $cdata = null)
    {
        ...
        $this->addAttributeDefinitions(array(
            ...
            'labelPlacement' => array(
                'required' => false,
                'type'     => 'enum',
                'values'   => array('right', 'left', 'bottom', 'top'),
                'since'    => '1.0'
            ),
