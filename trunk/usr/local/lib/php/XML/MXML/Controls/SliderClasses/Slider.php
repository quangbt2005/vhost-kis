...
/**
 * XML/MXML/Controls/SliderClasses/Slider.php
 *
 * Slider element.
 *
 * @package XML_MXML
 ...
 * @author   Markus Nix <mnix@docuverse.de>
 */
abstract class XML_MXML_Controls_SliderClasses_Slider extends XML_MXML_Core_UIComponent
{
    // {{{ public properties
    /**
     * Element name.
