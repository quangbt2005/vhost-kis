...
/**
 * XML/MXML/Controls/SimpleButton.php
 *
 ...
 * @author   Markus Nix <mnix@docuverse.de>
 */
class XML_MXML_Controls_SimpleButton extends XML_MXML_Core_UIComponent
{
    // {{{ public properties
    /**
     * Element name.
     ...
     * @var    string
     */
    public $elementName = 'SimpleButton';
