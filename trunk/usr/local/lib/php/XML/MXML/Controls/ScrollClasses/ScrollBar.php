...
/**
 * XML/MXML/Controls/ScrollClasses/ScrollBar.php
 *
 * ScrollBar element.
 *
 * @package XML_MXML
 ...
 * @author   Markus Nix <mnix@docuverse.de>
 */
class XML_MXML_Controls_ScrollClasses_ScrollBar extends XML_MXML_Core_UIComponent
{
    // {{{ public properties
    /**
     * Element name.
