...
/**
 * XML/MXML/Controls/NumericStepper.php
 *
 * NumericStepper element.
 *
 * @package XML_MXML
 ...
 * @author   Markus Nix <mnix@docuverse.de>
 */
class XML_MXML_Controls_NumericStepper extends XML_MXML_Core_UIComponent
{
    // {{{ public properties
    /**
     * Element name.
     ...
     * @var    string
     */
    public $elementName = 'NumericStepper';
