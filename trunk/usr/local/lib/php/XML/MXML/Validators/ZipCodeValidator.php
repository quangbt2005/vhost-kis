...
/**
 * XML/MXML/Validators/ZipCodeValidator.php
 *
 * ZipCodeValidator element.
 *
 * @package XML_MXML
 ...
 * @author   Markus Nix <mnix@docuverse.de>
 */
class XML_MXML_Validators_ZipCodeValidator extends XML_MXML_Validators_Validator
{
    // {{{ public properties
    /**
     * Element name.
     ...
     * @var    string
     */
    public $elementName = 'ZipCodeValidator';
    ...
    public function __construct($attributes = array(), $cdata = null)
    {
        ...
        $this->addAttributeDefinitions(array(
            ...
            'domain' => array(
                'required' => false,
                'type'     => 'enum',
                'values'   => array('US Only', 'US or Canada'),
                'since'    => '1.0'
            ),
            ...
            'wrongCAFormatError' => array(
                'required' => false,
                'type'     => 'string',
                'since'    => '1.0'
            ),
            'wrongLengthError' => array(
                'required' => false,
                'type'     => 'string',
                'since'    => '1.0'
            ),
            'wrongUSFormatError' => array(
                'required' => false,
                'type'     => 'string',
                'since'    => '1.0'
            )
