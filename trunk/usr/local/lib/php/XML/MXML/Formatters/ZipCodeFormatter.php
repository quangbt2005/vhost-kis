...
/**
 * XML/MXML/Formatters/ZipCodeFormatter.php
 *
 * ZipCodeFormatter element.
 *
 * @package XML_MXML
 ...
 * @author   Markus Nix <mnix@docuverse.de>
 */
class XML_MXML_Formatters_ZipCodeFormatter extends XML_MXML_Formatters_Formatter
{
    // {{{ public properties
    /**
     * Element name.
     ...
     * @var    string
     */
    public $elementName = 'ZipCodeFormatter';
