 ...
 * @author   Markus Nix <mnix@docuverse.de>
 */
class XML_MXML_ServiceTags_Argument extends XML_MXML_Element
{
    // {{{ public properties
    /**
     * Element name.
     ...
     * @var    string
     */
    public $elementName = 'argument'; // lowercase!
     ...
     * Always return true since we are dealing with user
     * defined data here we cannot validate.
     *
     * @param  boolean $caseInsensitive
     * @access public
     * @return boolean true
     */
    public function validate( $caseInsensitive = true )
    {
        return true;
    }
}
