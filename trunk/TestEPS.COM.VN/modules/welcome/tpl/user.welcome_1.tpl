	                    	...
	                    	<td rowspan="2">	                    		
	                    		...
	                    		<div id="group_chart_hose" class="group_chart">
		                        	<div style="overflow: auto; height: 220px;width:309px">
								        ...
								        <embed name='mySwf' src='/images/FinalIndexChart.swf?tradingSym=HOSE&dateFrom={$data.chart_startdate}&dateTo={$data.chart_today}&wsdl=http://www.eps.com.vn/ws/chart.php?wsdl'  pluginspage='http://www.adobe.com/go/getflashplayer' height='200px' width='360px' flashVars=''/>									
										</object>
		                            </div>                            
