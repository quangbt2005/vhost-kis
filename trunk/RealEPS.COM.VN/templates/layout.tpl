...
<meta name="description" content="KIS Vietnam - Cong ty chung khoan hang dau Vietnam. Cung cap cac dich vu chung khoan uy tin va chuyen nghiep: Moi gioi chung khoan,tu van dau gia,quan ly co dong,cam co ung truoc" />
...
<div id="wrapper">
	...
	<div id="banner">
    	<div class="right">
        	<div class="margin_bottom_5px" style="color: #000000"><label for="txt_quick_search">Tìm kiếm</label></div>
            ...
            <input type="submit" value="Xem" style="border: 1px dotted #FFF; background: rgb(254,254,254);padding: 3px;font-weight: bold"/>
            </div>
            <div>
           	<input type="radio" id="rad_ma_chung_khoan" {if $get.opt != 2}checked="checked"{/if} name="opt" value="1"/> <label for="rad_ma_chung_khoan" style="color: #000000">Mã chứng khoán</label>
            <input type="radio" id="rad_tintuc" name="opt" value="2" {if $get.opt == 2}checked="checked"{/if}/> <label for="rad_tintuc" style="color: #000000">Tin tức</label>
            </div>
        </div>
        <div class="clear"></div>
    </div>
