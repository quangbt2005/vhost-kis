{include file="$_MODULE_ABSPATH/tpl/user.hase.marketinfo.tpl"}
...
<div class="table_panel">
    <div class="header_left">
    	...
    	<tr><td>
        	<a href="/thong-ke/hase/index.html#table_listing" class="panel_button_active left" ><span>
        	<img src="/images/transparent.png" class="icon_panel1" style="margin-right:5px"/>GD Khớp lệnh HASE
        	</span></a>
        	<a href="/thong-ke/thoa-thuan/hase/index.html#table_listing" class="panel_button left margin_left_20px" ><span>
		...
		<table width="100%" border="1" class="table" bordercolor="#8f8f8f">
			...
			{/if}
				...
				<th>
					<table>
						<tr>
							<td width="50">{$item.StockSymbol}</td>
