...
<div style="border:1px solid #000000;width:955px;height:700px;">
    ...
    <param name='src' value="charts/TechnicalChart.swf?stockSymbol=ABT&stockExchangeID=1&dateFrom=2009-06-04&dateTo=2009-12-04&wsdl=http://www.eps.com.vn/ws/chart.php?wsdl"/>     
    <embed src="images/TechnicalChart.swf?stockSymbol={$get.symbol}&stockExchangeID={$data.seid}&dateFrom={$data.from_date}&dateTo={$data.to_date}&wsdl=http://www.eps.com.vn/ws/chart.php?wsdl" width="955px" height="700px" pluginspage='http://www.adobe.com/go/getflashplayer'  />     
    </object>
</div>
