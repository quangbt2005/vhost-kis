...
<div class="margin_bottom_10px">
	<div class="left box">
		Tổng Khối Lượng GD : {$data.bond_info.TotalVol|num_format:0}
	</div>
	<div class="left box margin_left_20px">
		Tổng Giá Trị GD : {$data.bond_info.TotalValue|num_format:0}
	</div>
	<div class="clear"></div>
</div>
<div>
	...
	<b>Thống kê giao dịch trái phiếu</b></div>
	...
	<tbody>
	{foreach from=$data.bond item="item" name="loop"}
