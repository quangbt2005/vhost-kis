...
define( 'CSV_LOG_HEADER', 'Server IP,function_name,key,transactionID,TransactionType,TransactionDate,CustomerCode,DestCustomerCode,Amount,Fee,Notes,bravo_bank_id,order_bank_id,Chinhanh,TransID_Rollback,Executed time' );
