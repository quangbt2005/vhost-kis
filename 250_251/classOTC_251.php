...
class COTC extends WS_Class{
	...
	function COTC($check_ip) {
		...
		$arr = array(
          ...
          'insertCoBuyOrder' => array( 'input' => array( 'CoAccountNo', 'AccountNo', 'StockID', 'OrderQuantity', 'OrderPrice', 'Session', 'FromTypeID', 'Note', 'OrderDate', 'IsAssigner', 'IsGotPaper', 'CreatedBy', 'AccountNoContra', 'CompanyNameContra'),
                      'output' => array( 'BuyingOrderID', 'SellingOrderID' )),

          'insertCoSellOrder' => array( 'input' => array( 'CoAccountNo', 'AccountNo', 'StockID', 'OrderQuantity', 'OrderPrice', 'Session', 'FromTypeID', 'Note', 'OrderDate', 'IsAssigner', 'IsGotPaper', 'CreatedBy', 'AccountNoContra', 'CompanyNameContra'),
                      'output' => array( 'BuyingOrderID', 'SellingOrderID' )),
	...
	*/
	function editPriceOfSellingOrder($OrderID, $NewOrderPrice, $UpdatedBy) {
		...
		if ( !required($OrderID) || !required($NewOrderPrice)) {
			...
			//$query = sprintf( "CALL sp_upcom_EditPriceOfTransferSellingOrderHN(%u, %u, '%s')", $OrderID, $NewOrderPrice, $UpdatedBy );
