...
<div class="table_panel">
    <div class="header_left">
    	...
    	<tr><td>
        	<a href="/thong-ke/hase/index.html#table_listing" class="panel_button left" ><span>
        	<img src="/images/transparent.png" class="icon_panel1" style="margin-right:5px"/>GD Khớp lệnh HOSE
        	</span></a>
        	<a href="/thong-ke/thoa-thuan/hase/index.html#table_listing" class="panel_button_active left margin_left_20px" ><span>
    ...
    <div class="panel_content">
			...
			<div>
				...
				{/if}
					...
					<th>{$item.PtMatchPrice|num_format:0}</th>
					<th>{$item.PtTotalTradedQtty|num_format:0}</th>
					<th>{$item.PtTotalTradedValue|num_format:0}</th>
				</tr>
				{/foreach}
				</tbody>
				</table>
