		...
		<div class="tabpanel margin_bottom_10px">
			...
			<!-- TONG QUAN NGANH -->
                ...
                <div class="left" style="margin-left: 10px;">
                    ...
                    <param name='src' value="/images/TechnicalChart_Small.swf?stockSymbol={$data.company.Symbol}&stockExchangeID={$data.company.SeId}&dateFrom={$data.chart_startdate}&dateTo={$data.chart_today}&wsdl=http://www.kisvn.vn/ws/chart.php?wsdl"/>     
                    <embed src="/images/TechnicalChart_Small.swf?stockSymbol={$data.company.Symbol}&stockExchangeID={$data.company.SeId}&dateFrom={$data.chart_startdate}&dateTo={$data.chart_today}&wsdl=http://www.kisvn.vn/ws/chart.php?wsdl" height="250" width="400" pluginspage='http://www.adobe.com/go/getflashplayer'  />     
                    </object>
                    </div>
