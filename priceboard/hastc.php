<?php
	...
	$trading = &new cTrading(2); // hcm: parameter = 1 
//	$stock_list = $trading->get_hn_stock_list(); 
...
<title>Bảng giá trực tuyến (HASTC)</title>
...
<div id="pagewrap">
		<div id="top">
    	<h1>BẢNG GIÁ TRỰC TUYẾN (HASTC)</h1>
    ...
    ?>
      <div style="width: 70px; float: left; overflow: hidden;">
	...
	<script>		
		Event.observe(window, "load", get_HASTC_HTML("<?php echo $_COOKIE['pattern']; ?>"));
  </script>  
</body>
</html>
<?php
